...
export default function Questionnaire() {
  ...
  const Field = ({ label, help, rows = 4, keyName, placeholder }:
    { label: string; help: string; rows?: number; keyName: string; placeholder: string }) => (
    <div>
        ...
        <div className="bg-bone/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg space-y-8">
          ...
          {step === 1 && (
            <>
              ...
              <Field keyName="before" label="Where did your story begin?"
                help="What were you doing before this work? What chapter came before the one you're in now?"
                placeholder="Before this I spent twelve years in corporate marketing. Before that I was pre-med for two years in college..." />
              <Field keyName="turningPoint" label="What was the turning point?"
                ...
                placeholder="The week I got passed over for a promotion I'd worked three years for, I photographed a brand shoot for a friend as a favor. She booked four clients from the photos. Something clicked..." />
              <Field keyName="hardWay" label="What did you have to figure out the hard way?"
              ...
              <Field keyName="life" label="Tell me about your life." rows={6}
                ...
                placeholder="I live in Scottsdale with my husband and our two golden retrievers, Biscuit and Gravy. I'm a total wine nerd and aggressively competitive at pickleball..." />
            </>
          )}
          ...
          {step === 2 && (
            <>
              ...
              <Field keyName="hero" label="Who is the person you most want to help?"
              ...
              <Field keyName="want" label="What do they want?"
                help="What are they actively trying to achieve or become?"
                placeholder="She wants to be seen as the go-to expert in her field..." />
              <Field keyName="externalProblem" label="What problem do you solve for them — the obvious one?"
              ...
              <Field keyName="internalProblem" label="And how does that problem make them feel?"
              ...
              <Field keyName="stakes" label="What's at stake if nothing changes?"
              ...
              <Field keyName="after" label="What does their life look like after working with you?"
          ...
          {step === 3 && (
            <>
              ...
              <Field keyName="personalityWords" label="Pick a few words that describe your brand personality." rows={2}
              ...
              <Field keyName="textingFriend" label="Text a friend about what you do — for real." rows={5}
              ...
              <Field keyName="standAgainst" label="What do you stand against?"
              ...
              <Field keyName="existingContent" label="Paste a piece of content you've written that felt like you." rows={5}
          ...
          {step === 4 && (
            <>
              ...
              <Field keyName="howSeen" label="How do you want to be seen in your industry?"
              ...
              <Field keyName="accomplish" label="What do you want to accomplish?"
              ...
              <Field keyName="horizon" label="Is there anything specific on the horizon?" rows={3}
            ...
            <>
              ...
              {hasBrand === 'existing' && (
                <>
                  ...
                  <Field keyName="existingDescribe" label="Describe your current brand."
                  ...
                  <Field keyName="existingWorking" label="What's working about it?"
                    help="What do you love? What gets compliments?"
                    placeholder="People always say my photos feel warm and approachable..." />
                  <Field keyName="existingNotWorking" label="What feels off, or could be stronger?"
              ...
              {hasBrand === 'fresh' && (
                <>
                  <button onClick={() => setHasBrand(null)} className="text-sm text-emerald font-body underline">← switch answer</button>
                  <Field keyName="brandReferences" label="Whose brand or aesthetic do you admire?"
                  ...
                  <Field keyName="hospitality" label="If your brand were a hotel or restaurant, what would it be?"
                  ...
                  <Field keyName="colors" label="What colors feel most like you?" rows={2}
              ...
              <Field keyName="wardrobe" label="How would you describe your personal style?"
              ...
              <Field keyName="spaces" label="What spaces or settings feel like you?"
          ...
          {step === 6 && (
            <>
              ...
              <Field keyName="cameraComfort" label="How do you feel about being photographed?" rows={3}
              ...
              <Field keyName="workday" label="Walk me through a real workday."
              ...
              <Field keyName="props" label="What objects or props represent your work?" rows={2}
              ...
              <Field keyName="specificShots" label="Any specific shots or images you know you need?"
              ...
              <Field keyName="avoid" label="Anything you want to avoid?" rows={2}
              ...
              <Field keyName="anythingElse" label="Anything else you want to add?" rows={4}
